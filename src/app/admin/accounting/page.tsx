...
function statusLabel(status: string) {
  switch (status) {
    case "OK":
      return {
        text: "\u0413\u043e\u0442\u043e\u0432\u043e",
        cls: "accounting-status--ok"
      };
    case "ERROR":
      return {
        text: "\u041e\u0448\u0438\u0431\u043a\u0430",
        cls: "accounting-status--error"
      };
    case "SYNCING":
      return {
        text: "\u0421\u0438\u043d\u0445\u0440\u043e\u043d\u0438\u0437\u0430\u0446\u0438\u044f",
        cls: "accounting-status--syncing"
      };
    default:
      return {
        text: "\u0415\u0449\u0435 \u043d\u0435 \u0437\u0430\u043f\u0443\u0441\u043a\u0430\u043b\u0438",
        cls: ""
      };
  }
}
    ...
    <div className="admin-grid accounting-grid">
      <section className="admin-card admin-card--wide">
        ...
        <p className="admin-muted">
          ...
          Google
          Sheets-&#x0432;&#x0438;&#x0442;&#x0440;&#x0438;&#x043d;&#x044b;:
          &#x0434;&#x043b;&#x044f; starvedas.ru &#x0438; chintamanidhama.ru.
          &#x041e;&#x0441;&#x043d;&#x043e;&#x0432;&#x043d;&#x043e;&#x0435;
          &#x0445;&#x0440;&#x0430;&#x043d;&#x0438;&#x043b;&#x0438;&#x0449;&#x0435;
          &#x0434;&#x0430;&#x043d;&#x043d;&#x044b;&#x0445; &mdash;
          &#x0431;&#x0430;&#x0437;&#x0430;
      ...
      {reports.map((report) => (
        <section
          className="admin-card accounting-card"
          key={report.sourceDomain}
        >
          <div className="admin-card__header">
            <div>
          ...
          <dl className="admin-summary-list">
            <div>
              <dt>&#x0421;&#x0442;&#x0430;&#x0442;&#x0443;&#x0441;</dt>
              <dd className={statusLabel(report.lastSyncStatus).cls}>
                {statusLabel(report.lastSyncStatus).text}
              </dd>
            </div>
            <div>
              <dt>
            ...
            <div>
              ...
              <dd>
                {formatDateTime(report.lastSyncedPeriodStart)} &mdash;{" "}
          ...
          {report.lastSyncError ? (
            <p className="form-error accounting-error">
              {report.lastSyncError}
            </p>
          ) : null}
          ...
          <form action={saveAccountingSpreadsheetAction} className="admin-form">
            ...
            <label className="field">
              ...
              <input
                defaultValue={
                  report.spreadsheetUrl ?? report.spreadsheetId ?? ""
                }
                name="spreadsheet"
                placeholder={
                  "https://docs.google.com/spreadsheets/d/... \u0438\u043b\u0438 ID"
                }
                type="text"
              />
            </label>
          ...
          <div>
            ...
            {report.logs.length > 0 ? (
              <div className="table-wrap accounting-log-wrap">
                <table className="admin-table accounting-log-table">
                  <thead>
                    <tr>
                      <th>&#x0421;&#x0442;&#x0430;&#x0440;&#x0442;</th>
                      <th>&#x0421;&#x0442;&#x0430;&#x0442;&#x0443;&#x0441;</th>
                  ...
                  <tbody>
                    {report.logs.map((log) => (
                      <tr key={log.id}>
                        ...
                        <td className={statusLabel(log.status).cls}>
