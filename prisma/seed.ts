...
const services = [
  ...
  },
  {
    ...
    detailsContent:
      "## Шраддха ягья\n\nЦеремония памяти предков, проводимая для благополучия ушедших душ. Каждый усопший указывается отдельно.\n\n## Особенности\n\n- Цена рассчитывается за каждого поимённо указанного усопшего\n- Имена читаются брахманами во время ягьи\n- Подходит для поминовения родственников",
