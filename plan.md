...
- [ ] После оформления заказа автоматически показывать покупку в личном кабинете клиента.
- [ ] На главной странице кабинета показывать приветствие, последнюю или актуальную покупку, статус заказа, кнопку оплаты, кнопку `Повторить покупку` и кнопку связи с куратором.
- [ ] Сделать раздел `Мои покупки` со списком всех заказов клиента.
- [ ] В списке покупок показывать: церемонию или услугу, дату оформления, сумму, статус, участников, куратора и основные действия.
...
- [ ] Сделать детальную страницу покупки с блоками: церемония, участники, контакты, оплата, куратор, история изменений и уведомления.
- [ ] В блоке оплаты показывать сумму, статус оплаты, ссылку на оплату, чек или квитанцию, если они есть.
- [ ] В блоке куратора показывать имя куратора, доступный канал связи и кнопку `Связаться с куратором`.
- [ ] Для MVP связь с куратором сделать через Telegram-ссылку или кнопку открытия чата.
...
- [ ] Сделать функцию `Повторить покупку`, которая создает новый заказ на основе старого.
...
- [ ] После нажатия `Повторить покупку` отправлять клиента в форму оформления, где он может проверить и изменить данные перед оплатой.
- [ ] Сделать редактирование покупки из кабинета до оплаты или до принятия заказа куратором в работу.
- [ ] Разрешить клиенту редактировать имя заказчика, Telegram, телефон, email, данные участников, комментарий и выбранную церемонию, если заказ еще не в работе.
- [ ] Запретить клиенту редактировать оплаченный заказ после передачи куратору, завершенный заказ, цену после оплаты и служебные поля.
- [ ] Если заказ уже в работе, вместо редактирования показывать подсказку `Для изменения данных напишите вашему куратору` и кнопку связи с куратором.
- [ ] Сделать раздел `Профиль`, где клиент редактирует имя, Telegram, телефон, email, язык общения, согласия и настройки уведомлений.
- [ ] Добавить раздел уведомлений в кабинете: заказ создан, заказ оплачен, куратор назначен, куратор написал сообщение, нужно уточнить данные, заказ завершен, покупку можно повторить.
- [ ] Хранить историю оплат и чеки по заказам клиента.
- [ ] Рассмотреть сохраненных участников, чтобы клиент мог быстро выбирать людей для повторных покупок.
...
- [ ] Детальная страница покупки.
- [ ] Повтор покупки.
- [ ] Редактирование заказа до оплаты.
- [ ] Блок `Мой куратор`.
