...
- [~] Настроить обновление данных примерно 1 раз в сутки. Готово в коде: `/api/accounting/sync`; осталось подключить cron/Dokploy с `ACCOUNTING_SYNC_SECRET`.
...
- [~] Реализовать ежедневное обновление данных 1 раз в сутки. Готов endpoint `/api/accounting/sync`; нужно подключить расписание.
...
- [x] Ручное обновление.
- [~] Ежедневное обновление. Готов endpoint; нужно подключить cron.
- [x] Вкладки MVP:
  - [ ] `Операции`;
  - [ ] `Дневная сводка`;
  - [ ] `Месячная сводка`;
